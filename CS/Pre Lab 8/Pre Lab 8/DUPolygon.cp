...
//----------------------------------------------------------------------------
    ...
    DUPolygon::DUPolygon(DUPolygon const &polygon)
    {
        numPoints_ = polygon.numPoints_;
        closed_polygon_ = polygon.closed_polygon_;
        first_ = polygon.first_;
        last_ = polygon.last_;
    }
	...
	//----------------------------------------------------------------------------
        ...
        void DUPolygon::operator+(const DUPoint &p)
        {
            DUPolygonNode* ptr ;
            ptr = new DUPolygonNode(p) ;
            if( last_ != NULL )
        ...
        DUPoint DUPolygon::operator[](int i)
        {
            DUPolygonNode* ptr ;
	...
	//----------------------------------------------------------------------------
        ...
        void DUPolygon::operator=(const DUPolygon &polygon)
        {
